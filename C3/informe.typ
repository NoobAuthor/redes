#import "@preview/minerva-report-fcfm:0.1.0": report

#show: report.with((
  titulo: "Actividades de Redes: Forwarding Básico y Fragmentación IP",
  subtitulo: "Simulación de Mini-Internet con Sockets UDP",
  autores: (
  ...
  nombre-curso: "Redes de Computadores",
